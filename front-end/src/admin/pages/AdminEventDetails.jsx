  ...
  return (
    <div className="admin-event-page">
      <AdminSidebar />
        ...
        <h1 className="admin-event-title">{event.eventName}</h1>
        <div className="admin-event-images">
          <div id="adminCarousel" className="carousel slide" data-bs-ride="carousel">
            <div className="carousel-inner">
              <div className="carousel-item active">
                <img src={`http://localhost:5000/${event.image1}`} alt="Event 1" />
              </div>
              <div className="carousel-item">
                <img src={`http://localhost:5000/${event.image2}`} alt="Event 2" />
              </div>
              <div className="carousel-item">
                <img src={`http://localhost:5000/${event.image3}`} alt="Event 3" />
              </div>
            </div>
            ...
            <button className="carousel-control-next" type="button" data-bs-target="#adminCarousel" data-bs-slide="next">
              ...
              <button className="btn-update" onClick={handleUpdate}>Update Event</button>
              <button className="btn-delete" onClick={handleDelete}>Delete Event</button>
            </div>
              </div>
              <div className="admin-event-info-box">
            <div className="admin-event-meta">
              <p><FontAwesomeIcon icon={faCalendar}/> {new Date(event.eventDate).toLocaleDateString()}</p>
